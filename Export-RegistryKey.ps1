...
Export-Registry HKLM:\SYSTEM\CurrentControlSet\Control\TimeZoneInformation -ExportType xml -ExportPath C:\Script\TimeZone.xml

### IMPORT ###

$data=Import-Clixml C:\Script\TimeZone.xml
